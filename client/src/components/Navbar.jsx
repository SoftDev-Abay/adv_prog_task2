...
const Navbar = ({ setIsOpenAddBuildingModal, setIsOpenLoginModal }) => {
        ...
        <div className="flex items-center gap-3 md:gap-9">
          {user && (
            <>
              ...
              <div className="relative flex items-center gap-3 border px-2 py-1 rounded-3xl border-gray-100">
                <RxHamburgerMenu
                  onClick={() => {
                ...
                />
                {dropDownMenuOpen && (
                  <div className="absolute border-2 top-3 -right-5 mt-10 w-40 bg-white rounded-xl  shadow-2xl z-50 ">
                    <div className="flex flex-col items-center gap-2 py-4">
                      <div className="flex flex-col items-center gap-2 w-full">
                        <button
                          className="w-full text-center  py-2  hover:bg-gray-100  flex items-center justify-center gap-4"
                          onClick={() => {
                            console.log("clicked");
                          }}
                        >
                        ...
                        >
                          <FaSignOutAlt className="text-xl text-gray-500" />
                          <span
